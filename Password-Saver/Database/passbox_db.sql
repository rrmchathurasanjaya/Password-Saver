...
CREATE TABLE IF NOT EXISTS `password_database_tb` (
...
(4, 'chathura sanjaya', 'admin', 'admin', 'rrmchathura@gmail.com', '0718831661'),
(5, 'piyumi anjula', 'piyu', 'piyu', 'piyu@gmail.com', '234567ui');
